...
///
/// IMPORTANT: This mirrors `AlbumManifest` in the iPhone target
/// (`EclipseiPhone/EclipseiPhone/AlbumManifest.swift`) and MUST stay in
/// sync with it (see `Scripts/verify_shared_sources.sh`).
