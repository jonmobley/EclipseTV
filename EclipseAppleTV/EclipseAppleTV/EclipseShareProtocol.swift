...
///
/// IMPORTANT: This file is intentionally duplicated verbatim in the iPhone target
/// (`EclipseiPhone/EclipseiPhone/EclipseShareProtocol.swift`). The two copies MUST
